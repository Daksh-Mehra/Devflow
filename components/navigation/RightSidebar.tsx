...
const RightSidebar = () => {
  ...
  return (
    <section className='pt-36 sticky top-0 right-0 custom-scrollbar background-light900_dark200 p-6 light-border flex h-screen flex-col gap-6 overflow-y-auto border-l shadow-light-300 dark:shadow-none max-xl:hidden w-[350px]'>
        <div>
